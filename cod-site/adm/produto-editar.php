                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="pessoais">
                                    <div class="post"><br>
                                        <form id="Produto-edit" name="Produto-edit" class="form-horizontal" action="produto-editar-gravar.php" method="post" onsubmit="return checkCheckBox(this)" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control" name="inputNome" id="inputNome" value="<?php echo $produto->nome ?>">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control" name="inputPeso" id="inputPeso" value="<?php echo $produto->peso ?>">
                                                        </div>
                                                        <label for="inputTipo" class="col-md-1 control-label">Tipo:</label>
                                                        <div class="col-sm-4">
                                                            <select name="inputTipo" id="inputTipo">
                                                                <option value="<?php echo $produto->tipo ?>">TENIS</option>
                                                                <option value="<?php echo $produto->tipo ?>">ROUPAS</option>
                                                                <option value="<?php echo $produto->tipo ?>">ACESSORIOS</option>
                                                            </select>
                                                        </div>
                                                    </div>                                  
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control" name="inputPreco" id="inputPreco" value="<?php echo $produto->preco ?>">
                                                        </div>
                                                        <label for="inputDescricao" class="col-md-3 control-label">Descrição do produto:</label>
                                                        <div class="col-sm-2">
                                                          <textarea name="inputDescricao" id="inputDescricao" cols="50" rows="3" ><?php echo $produto->descricao ?></textarea>
                                                        </div>
                                                        <div class="col-xs-12">
